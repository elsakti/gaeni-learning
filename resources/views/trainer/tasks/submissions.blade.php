                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('trainer_delete_submission', $submission->id ) }}" method="POST">
                                            <a href="{{ route('trainer_edit_submission', $submission->id) }}" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Grade">
