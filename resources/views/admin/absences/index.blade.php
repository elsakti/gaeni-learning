                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $absence->date }}</td>
                                    <td>{{ $absence->open_time }}</td>
                                    <td>{{ $absence->closed_time ? $absence->closed_time : 'ON GOING' }}</td>
                                    <td>{{ $absence->status ? 'Opened' : 'Closed' }}</td>
                                    <td>
                                        <form action="{{ route('admin_delete_absence', $absence->id) }}" method="POST">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove Absence">
