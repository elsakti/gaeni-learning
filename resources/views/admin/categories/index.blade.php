                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr id="category_ids{{ $item->id }}">
                                    ...
                                    <td></td>
                                    <td>
                                        <a class="btn btn-warning" href="{{ route('admin_edit_categories', [ 'id' => $item->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
