                        ...
                        <div class="loginarea__wraper">
                            ...
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="login__form">
                                    ...
                                    <input class="common__login__input @error('phone') is-invalid @enderror" name="phone" id="phone" type="number" placeholder="Phone example: 08123789****" autocomplete="phone" value="{{ session('') }}" autofocus required>
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
